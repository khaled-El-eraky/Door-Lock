 ...
 * (4-bit Mode)			four bus lines (DB4 to DB7) are used for transfer to transfer data, the four high order bits then the four low order bits.
 *
 *
 ****************************** pinout Functions *****************************
 *
...
#define LCD_H___
	...
	#define LCD_CONTROL_IO 	DIOB

	#define LCD_Data_IO		DIOB
